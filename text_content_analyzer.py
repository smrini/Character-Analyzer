...
print("Welcome to the Text Content Analyzer!")
print("This program reads a text file and analyzes the frequency of different characters in its content.")
...
def analyze_text(text_path):
    while True:
        try:
            ...
            # If the text file is read successfully, break the loop
            break

        except Exception as e:
            print("An error occurred while reading the text file!")
            print(f"Invalid path:{text_path}")
            text_path = input("Please enter a valid path: ")
        ...
        if save_results in ['y', 'yes']:
            try:
                ...
                with open(results_file_path, 'w') as f:
                    f.write(f"characters frequency of the content in text file:\n{text_path}\n\n")
...
text_path = input("Please enter the path to the text file: ")

# Call the function with the entered text file path
analyze_text(text_path)